...
## Much borrowed from https://mths.be/osx
...
#Enables three finger swipe down to just show current app
defaults write showAppExposeGestureEnabled -int 1
